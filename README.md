...
- **Polymarket Latency Arbitrage Bot** — Python bot that exploits price lag between Binance/Coinbase spot data and Polymarket's BTC/ETH/SOL 15-min markets. Async architecture, Kelly sizing, Telegram alerts.
